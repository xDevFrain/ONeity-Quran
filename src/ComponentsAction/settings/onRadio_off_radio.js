  ...
  async action(client, interaction, parts, lang) {
    try {
      ...
      if (!findRadio) {
        ...
        //   content: "⚠ | Please change radio Channel to play | **من فضلك قم بتغير القناه بسبب عدم العثور عليها **",
        //   ephemeral: true
        // });
      }
      if (!data.enabled) {
        ...
        if (conn == "cantConnect") return interaction.followUp({ content: "⚠ | لا يمكن للبوت الدخول للقناه الصوتيه" });
